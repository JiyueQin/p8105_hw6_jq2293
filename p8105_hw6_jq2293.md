...
0, but three outliers can be noticed.
...
while model\_1 has the highest distribution of rmse. model\_2 has
similar performance compared to mine. In general, from the perspective
of distribution of rmse, I will keep my original model.
