...
In general, the plot shows that residuals are randomly scattered around 0, but three outliers can be noticed. 
...
From the plot, we can see my model has lowest distribution in rmse, while model_1 has the highest distribution of rmse. model_2 has similar performance compared to mine. In general, from the perspective of distribution of rmse, I will keep my original model.